...
DJPlus v0.10.0 es una biblioteca musical local para DJs, basada en PySide6, SQLAlchemy y SQLite.

Estado: v0.10.0 preparada para revisión de release; el commit y tag requieren aprobación explícita.
